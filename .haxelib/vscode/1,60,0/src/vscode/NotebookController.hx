...
typedef NotebookController = {
	 ...
	 */
	var ?supportsExecutionOrder:Bool;
	 ...
	 */
	var executeHandler:(cells:Array<NotebookCell>, notebook:NotebookDocument, controller:NotebookController) -> Thenable<Void>;
	 ...
	 */
	var ?interruptHandler:(notebook:NotebookDocument) -> Thenable<Void>;
	 ...
	 */
	function updateNotebookAffinity(notebook:NotebookDocument, affinity:NotebookControllerAffinity):Void;
