...
// Build file: haxe.ui.ComponentBuilder.build("assets/exclude/data/ui/chart-editor/dialogs/upload-chart.xml")
@:access(funkin.ui.debug.charting.ChartEditorState)
class ChartEditorUploadChartDialog extends ChartEditorBaseDialog
{
  public var dropHandlers:Array<DialogDropTarget> = [];
   ...
   */
  public function onDropFileChartBox(pathStr:String):Void
  {
   ...
   */
  public function onSelectFile(selectedFile:SelectedFileInfo):Void
  {
    this.unlock();
  ...
  public function onCancelBrowse():Void
  {
    this.unlock();
  }
}
