...
// Build file: haxe.ui.macros.ComponentMacros.build("assets/exclude/data/ui/stage-editor/dialogs/find-object.xml")
class FindObjDialog extends Dialog
{
  public var stageEditorState:StageEditorState;

  public var assets:Array<StageEditorObject> = [];
  public var curSelected:Int = 0;
  public var field:TextField;

  public var checkWord:CheckBox;
  public var checkCaps:CheckBox;
